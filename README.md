...
The microservice is known to be built and run successfully under **Ubuntu Server (Ubuntu 22.04.2 LTS x86-64)**. Install the necessary dependencies (`openjdk-17-jre-headless`, `clojure`, `leiningen`, `make`, `docker.io`):
...
```
$ java -jar target/uberjar/bus-0.20.2.jar; echo $?
...
```
...
PID   USER     TIME  COMMAND
    1 daemon    0:06 java -jar bus.jar
   24 daemon    0:00 sh
